...
@org.hibernate.annotations.NamedNativeQuery(name="TotalVoteForIssueMapping",
        query = "select tbl_option.option_id,tbl_option.option_title, count(tbl_vote_option.option_id) as total_votes,tbl_vote_option.preference,tbl_votes_type.vote_type_title from tbl_option,\n" +
                ...
                "group by tbl_option.option_id,tbl_option.option_title,vote_type_title,tbl_vote_option.preference",
...
@org.hibernate.annotations.NamedNativeQuery(name="getNewOptionList",
        ...
        "tbl_users_vote.round_id = tbl_round.round_id and tbl_issue.issue_id = ? and tbl_users_vote.user_id IN(?)\n" +
        "group by tbl_option.option_id,tbl_option.option_title,vote_type_title,tbl_vote_option.preference",
        resultSetMapping="TotalVoteForIssueMapping"
)
